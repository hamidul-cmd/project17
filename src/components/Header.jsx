  ...
  return (
    <>
      <div className="bg-white dark:bg-black-900">
        <header className="max-w-wrapper m-auto flex justify-between py-2.5 px-4 items-center 3xl:py-4.8 3xl:px-20">
          <a href="/">
            <img
              src="https://i.imgur.com/Fjw8iCy.png"
              alt="logo"
              className="block dark:hidden"
            />
            <img
              src="https://i.imgur.com/5yCGQVS.png"
              alt="logo bark"
              className="hidden dark:block"
            />
          </a>
          <ul className="hidden xll:flex gap-10">
            {navlinks.map((link, index) => (
              <li
                key={index}
                className="text-sm font-semibold leading-6 text-black-700 dark:text-white"
              >
          ...
          <div className="flex gap-4 items-center">
            <div className="hidden xll:flex gap-5 items-center">
              <a
                href=""
                className="text-sm font-semibold leading-6 text-black-700 dark:text-white"
              >
